...
# cd /mnt
# ./*.run
# After the above operation, you should chech whether vboxsf has installed or not as below
# lsmod | grep vboxsf
# It shows the correct installation if the result displayed like below:
#vboxsf                 37328  1 
